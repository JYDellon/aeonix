...
function Accueil() {
    ...
    <div className="accueil-container">
        {/* Cartes */}
        <div className="cardm" onClick={() => navigate('/etapesCreationSite')}>
            <h3>{t('cards.siteWebTitle')}</h3>
            <h3>{t('cards.siteWebSubtitle')}</h3>
        </div>
        <div className="cardmDevis" onClick={() => navigate('/devis')}>
            <h3>{t('cards.devisTitle')}</h3>
            <h3>{t('cards.devisSubtitle')}</h3>
        </div>
    </div>
    {/* Déplacer le carousel ici */}
    <div className="carousel-container">
        <Slider {...settings}>
            <div className="slide">
                <div className="slide-content">
                    <img src={siteVitrine} alt={t('carousel.slide1')} className="carousel-image" />
                    <h3>{t('carousel.slide1')}</h3>
                </div>
            </div>
            <div className="slide">
                <div className="slide-content">
                    <img src={siteEcommerce} alt={t('carousel.slide2')} className="carousel-image" />
                    <h3>{t('carousel.slide2')}</h3>
                </div>
            </div>
            <div className="slide">
                <div className="slide-content">
                    <img src={sitePersonnalise} alt={t('carousel.slide3')} className="carousel-image" />
                    <h3>{t('carousel.slide3')}</h3>
                </div>
            </div>
        </Slider>
    </div>
