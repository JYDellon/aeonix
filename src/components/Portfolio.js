...
//                 const response = await axios.post('https://apiaeonix-production-3187.up.railway.app/api/visit/portfolio', {}, {
//                     headers: {
    ...
    try {
      ...
      if (!visitedPages[pageName]) {
        const response = await axios.post(
          'https://apiaeonix-production-3187.up.railway.app/api/visit/portfolio',
          {},
          {
            headers: {
              'Content-Type': 'application/json',
