...
//                 const response = await axios.post('https://api-aeonix-git-master-dellons-projects.vercel.app/api/visit/portfolio', {}, {
//                     headers: {
    ...
    try {
      ...
      if (!visitedPages[pageUrl]) {
        const response = await axios.post(
          'https://api-aeonix-git-master-dellons-projects.vercel.app/api/visit/portfolio',
          {},
          {
            headers: {
              'Content-Type': 'application/json',
