...
function Dashboard() {
  ...
  useEffect(() => {
    if (activeTab === 'visits') {
      axios
        .get('https://aeonixbackend.vercel.app/api/visit')
        .then((response) => {
  ...
  const fetchProspects = () => {
    axios
      .get('https://aeonixbackend.vercel.app/api/prospects')
  ...
  const handleCreateProspect = () => {
    axios
      .post('https://aeonixbackend.vercel.app/api/prospects', newProspect)
      .then(() => {
        fetchProspects();
  ...
  const handleUpdateProspect = () => {
    if (editingProspect) {
      axios
        .put(`https://aeonixbackend.vercel.app/api/prospect/${editingProspect.id}`, editingProspect)
        .then(() => {
          fetchProspects();
  ...
  const handleDeleteMultiple = () => {
    ...
    axios
      .post('https://aeonixbackend.vercel.app/api/prospects/delete', { ids: selectedProspects })
      .then(() => {
  ...
  const sendAllEmails = async () => {
    ...
    try {
      ...
      await axios.post('https://aeonixbackend.vercel.app/api/send-emails', {
